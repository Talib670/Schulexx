...
{
    public partial class ViewEditnonTeachingstaff : UserControl
    {
        public ViewEditnonTeachingstaff()
        {
            InitializeComponent();
        }
        ...
        private void ViewEditnonTeachingstaff_Load(object sender, EventArgs e)
        {
            load_list();
