...
{
    public partial class SmsMessageTemplatess : Form
    {
        public SmsMessageTemplatess()
        {
            InitializeComponent();
        }
        ...
        public void insert_update()
        {
            ...
            Local_aRsms.title = new Connectoperations().validate_All_Data(smsTbx.Text);
            Local_aRsms.message_type = "sms";
            if (get_id == 0)
            {
        ...
        public void Load_List()
        {
            try
            {
                ...
                Load_aRsms = Process_aRsms.GetAlertremindersList("where message_type='sms'");
        ...
        private void SmsMessageTemplatess_Load(object sender, EventArgs e)
        {
            Load_List();
        }
        ...
        private void listView1_ItemSelectionChanged(object sender, ListViewItemSelectionChangedEventArgs e)
        {
            ...
            smsTbx.Text = e.Item.SubItems[1].Text;
